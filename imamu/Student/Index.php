                                    ...
                                    <div class="page-content-inner">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <!-- BEGIN WIDGET THUMB -->
                                                <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                                    <h4 class="widget-thumb-heading">Has problem</h4>
                                                    <div class="widget-thumb-wrap">
                                            ...
                                            <div class="col-md-4">
                                                <!-- BEGIN WIDGET THUMB -->
                                                <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 ">
                                                    <h4 class="widget-thumb-heading">Accept</h4>
                                                    <div class="widget-thumb-wrap">
                                               ...
                                               <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="fa fa-comments"></i> Schedule </div>
                                                        <div class="tools">
                                                        ...
                                                        <div class="table-scrollable">
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <th> 4-5 </th>
                                                                        <td class="danger"> <a href="Student.html" > course <br>123 </a> </td>
                                                                       <td>  </td>
                                                                        <td>  </td>
                                                                       <td>  </td>
                                                                    </tr>
