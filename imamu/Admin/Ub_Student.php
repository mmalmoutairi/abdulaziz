                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="register-form" action="controller/updateStudent.php?id=<?php echo $array[0]->id; ?>" method="post">

                                    <div class="form-group">
                                        <label class="control-label visible-ie8 visible-ie9">First Name </label>
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="<?php echo $array[0]->first_name; ?>" name="first_name" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text" placeholder="<?php echo $array[0]->student_id; ?>" name="student_id" /> </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" id="register-submit-btn" name="updateStudent" class="btn btn-success uppercase pull-left">Update</button>
                                    </div>
                                </form>
