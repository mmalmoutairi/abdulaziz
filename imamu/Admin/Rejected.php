...
include 'header.php';
include '../db/db.php';
$query = "select r.id ,  u.first_name , u.middle_name , u.third_name , u.last_name , s.name as semester_name , c.name as course_name from request r , user u , semester s , course c where r.student_id = u.id AND r.semester_id = s.id AND r.course_id = c.id and r.status = 2 order by `id` desc";
