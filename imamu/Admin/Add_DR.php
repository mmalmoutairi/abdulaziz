                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form name="myForm" onsubmit="return validateForm();" class="register-form" action="controller/addDR.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control placeholder-no-fix" type="text" minlength="10" maxlength="10" placeholder="National ID" name="national_id" required /> </div>
                                    <div class="form-group">
