...
if ($id != 0) {
    ...
    if ($count > 0) {
        ...
        ?>
        <script>
            window.location = "DR_management.php";
        </script>
        <?php
    }
} else {
                    ...
                    <div class="page-content-inner">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="register-form" action="controller/UB_DOCTOR.php?id=<?php echo $array[0]->id; ?>" method="post">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" id="register-submit-btn" name="updateDR" class="btn btn-success uppercase pull-left">Update</button>
                                    </div>
                                </form>
