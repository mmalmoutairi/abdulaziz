                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="actions">
                                            <div class="actions">
                                                <div class="actions"><a class="btn btn-transparent red btn-outline btn-circle btn-sm active" href="Add_Employee.php"><i class="fa fa-plus"></i>Add Employee</a>
                                                </div>
                                        ...
                                        <div class="table-scrollable">
                                                    ...
                                                    if (@count($array) > 0) {
                                                      ...
                                                      <?php
                                                        ...
                                                        foreach ($array as $key => $value) {
                                                            if ($value->status == 1) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                    <td> <a href="UB_Employee.php?id=<?php echo $value->id; ?>" class="btn btn-outline btn-circle btn-sm purple">
                                                        ...
                                                        ?>
                                                        <div class="alert alert-danger">
                                                            <strong>Alert !</strong> No Employee in database
                                                        </div>
                                                        <?php
                                                    }
                                                    ?>
